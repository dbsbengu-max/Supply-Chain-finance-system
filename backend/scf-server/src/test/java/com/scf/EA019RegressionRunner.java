    ...
    public static void main(String[] args) {
        LauncherDiscoveryRequest request = LauncherDiscoveryRequestBuilder.request()
                .selectors(
                        ...
                        DiscoverySelectors.selectClass("com.scf.finance.FinancePreCheckIntegrationTest"),
                        ...
                        DiscoverySelectors.selectClass("com.scf.saga.SagaOpsIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.saga.SagaEa037IntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.document.DocumentCenterIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.ContractSignIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.ContractSignCallbackSecurityIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.ContractSignConfigIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.ContractSignReconciliationIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.ContractSignHttpEsignIntegrationTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.HttpProviderFieldMapperTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.OutboundSignAuthStrategyTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.HttpContractSignProviderTest"),
                        DiscoverySelectors.selectClass("com.scf.contract.service.ContractSignRolloutResolverTest"),
                        DiscoverySelectors.selectClass("com.scf.iam.config.DevDataInitializerProdTest"),
