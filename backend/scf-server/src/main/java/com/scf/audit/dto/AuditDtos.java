...
public final class AuditDtos {
    ...
    public static Map<String, String> actionLabels() {
        return Map.ofEntries(
                ...
                Map.entry("WAREHOUSE_UNFREEZE", "库存解冻"),
                ...
                Map.entry("AGENCY_PURCHASE_APPROVE", "代采审批通过"),
                Map.entry("AGENCY_PURCHASE_REJECT", "代采审批驳回"),
                Map.entry("AGENCY_PURCHASE_SAGA_SUCCESS", "代采 Saga 成功"),
                Map.entry("ACCOUNT_MARGIN_FREEZE", "保证金冻结"),
                Map.entry("ACCOUNT_MARGIN_UNFREEZE", "保证金解冻"),
